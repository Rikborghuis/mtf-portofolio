<template>
    ...
    <div class="flex items-center fixed z-30 justify-center h-16 w-full border-black lg:hidden shadow-lg ">
                            ...
                            <div class="bg-blue h-lvh flex flex-col justify-between">
                                <header class=" flex items-center justify-between w-full bg-white relative">
                                    <div class="flex items-center justify-between p-3 w-full">
                                        ...
                                        <div class=""><a href="/"><img class="h-10" :src="'/img/logo.webp'"></a></div>
                                        <div>
                                            <a class="orange-button" href="/overons"> Contact </a>
                                        </div>
                                    </div>
                                </header>
                                <div class="flex flex-col gap-12 ">
                                    <div class="flex flex-col">
                                        <div class="grid text-white text-center">
                                            <a href="/aanbod" class="py-4"><span>Aanbod</span></a>
                                            <a href="/overons#services" class="py-4"><span>Services</span></a>
                                            <a href="/overons" class="py-4"><span>Over ons</span></a>
                                            <a href="/overons#contactform" class="py-4"><span>Contact</span></a>
                                        </div>
                                    </div>
        ...
        <header class="grid grid-cols-5 xs:grid-cols-3 w-full bg-white relative">
            ...
            <div class="flex items-center justify-center"><a class="hidden xs:block" href="/"><img class="h-10"
                        :src="'/img/logo.webp'"></a>
                <a class="block xs:hidden" href="/"><img class="h-10" :src="'/img/mobilelogo.webp'"></a>
            </div>
    ...
    <div class="hidden lg:block shadow-lg">
        <header class="flex justify-center z-50 app ">
            <nav class="navbar flex justify-between items-center mt-5 fixed py-0.5 px-4 h-16 w-11/12 max-w-7xl bg-white border-black  transition-all duration-300"
                :class="{ 'navbar--hidden': !showNavbar }">
                <a href="/" class="items-center">
                    <img class="h-10" :src="'/img/logo.webp'" </a>
                    <div class="flex justify-between gap-8 ml-28">
                        <div><a href="/aanbod">Aanbod</a></div>
                        <div><a href="/overons#services">Services</a></div>
                        <div><a href="/overons">Over ons</a></div>
                    </div>
                    <div class="flex gap-4">
                        <!--TO WHATSAPP TEL:-->
                        <Button label="Whatsapp" icon="pi pi-whatsapp" class="orange-button" />
                        <a href="/overons#contactform" class="clear-black-button">
                            Contact
                        </a>
                    </div>
            </nav>
